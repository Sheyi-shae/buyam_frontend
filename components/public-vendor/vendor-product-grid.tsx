...
import ProductSorting from "../product/product-sorting"
...
export default function VendorProductGrid({defaultProducts, setDefaultProducts,  }: ProductGridProps) {
...
{defaultProducts.length===0 && (<p className="text-center text-muted-foreground">No products found.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {defaultProducts?.map((item) => (
          ...
          >
         <ProductCardSlide item={item} intervalMs={3000} queryFn="user-profile" queryParams={item.sellerPublicId} />
